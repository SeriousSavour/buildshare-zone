...
export const HomeIcon = (props: LucideProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" className="fill-primary/20 stroke-primary" />
...
export const ActivityIcon = (props: LucideProps) => (
  <svg
    ...
    {...props}
  >
    <rect x="2" y="6" width="20" height="12" rx="2" className="fill-accent/20 stroke-accent" />
...
export const FriendsIcon = (props: LucideProps) => (
  <svg
    ...
    {...props}
  >
    <circle cx="9" cy="7" r="4" className="fill-secondary/20 stroke-secondary" />
    <path d="M3 21v-2a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v2" className="stroke-secondary" />
    <circle cx="16" cy="8" r="3" className="fill-secondary/30 stroke-secondary" />
...
export const ChatIcon = (props: LucideProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" className="fill-blue-500/20 stroke-blue-500" />
...
export const ToolsIcon = (props: LucideProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z" className="fill-orange-500/20 stroke-orange-500" />
  </svg>
);
...
export const HelpIcon = (props: LucideProps) => (
  <svg
    ...
    {...props}
  >
    <circle cx="12" cy="12" r="10" className="fill-green-500/20 stroke-green-500" />
...
export const PhilosophyIcon = (props: LucideProps) => (
  ...
  >
    ...
    <path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z" className="fill-purple-500/20 stroke-purple-500" />
...
export const ProfileIcon = (props: LucideProps) => (
  <svg
    ...
    {...props}
  >
    <circle cx="12" cy="8" r="5" className="fill-pink-500/20 stroke-pink-500" />
...
export const SettingsIcon = (props: LucideProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z" className="fill-cyan-500/20 stroke-cyan-500" />
